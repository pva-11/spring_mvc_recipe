...
import mvc.spring.example.recipe.services.ImageService;
...
public class ImageController {
    ...
    public String updateRecipeImage(@PathVariable String id, Model model){
        model.addAttribute("recipe",recipeService.getById(Long.valueOf(id)));
        return "recipe/imageform";
    }

    @PostMapping("recipe/{id}/image")
    public String saveRecipeIngredientsViewPage(@RequestParam("imagefile") MultipartFile image,
